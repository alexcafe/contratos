...
class Auth extends CI_Controller
{
	...
	public function index()
	{
		...
		else
		{
			...
			$this->load->view('autenticacao/login', $this->data);
		}
	}
	...
	public function change_password()
	{
		...
		if ($this->form_validation->run() === FALSE)
		{
			...
			$this->load->view('autenticacao/alterar_senha', $this->data);
		}
		else
		{
			...
			{
				$this->session->set_flashdata('message', $this->ion_auth->errors());
				redirect('alterar_senha', 'refresh');
			}
		}
	}
	...
	public function forgot_password()
	{
		...
		if ($this->form_validation->run() === FALSE)
		{
			...
			$this->load->view('templates/top');
			$this->load->view('autenticacao/recuperar-senha', $this->data);
		}
		else
		{
			...
			if (empty($identity))
			{
				...
				$this->session->set_flashdata('message', $this->ion_auth->errors());
				redirect("recuperar_senha", 'refresh');
			}
